                                        ...
                                        <div class="row">
                                            <div class="col-md-10 col-md-offset-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter your caseTitle" id="caseTitle">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" placeholder="Enter your caseDate" id="caseDate">
                                                </div>

                                                <div class="form-group">
                                                    <label>Enter your caseDesc:</label>
                                                    <input type="text" class="form-control" placeholder="Enter your teamProfessional" id="caseDesc">
                                                </div>

                                                <div class="form-group">
                                                    <label>Enter your caseClass:</label>
                                                    <input type="text" class="form-control" placeholder="Enter your caseClass" id="caseClass">
                                                </div>

                                                <div class="form-group">
                                                    <label>Enter your caseSource:</label>
                                                    <input type="text" class="form-control" placeholder="Enter your caseSource" id="caseSource">
                                                </div>


                                                <div class="form-group">
                                                    <label>Your caseContent:</label>
                                                    <textarea rows="5" cols="5" class="form-control" placeholder="Enter your message here" id="caseContent"></textarea>
                                                </div>
