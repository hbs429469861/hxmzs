...
public class MapToXMLString {
     ...
     * @param dataMap 
     *
     * @param xmlOrJsonList  the data map
     *
     * @return the string
     */
    public static String converter(TreeMap<String, String> dataMap, String xmlOrJsonList,String Rootstr)
    {
        synchronized (MapToXMLString.class)
        {
            ...
            System.out.println("=======strBuilder=========dataMap========"+ strBuilder.toString());
            strBuilder.append(coverter(xmlOrJsonList));
            strBuilder.append("</"+Rootstr+">");
            System.out.println("=======strBuilder=========dataMap========"+ strBuilder.toString());
    ...
    /**
     * @describe 包装代发代付的发送报文里的包含Item的List
     * @packagename com.jbh.util.yeePayForAnother
     * @author 李海燕
     * @date 2017年3月21日
     * @param objects
     * @return
     */
    public static String converterCutHeadForXmlList(String xmlOrJsonItem,String Rootstr)
    {
        synchronized (MapToXMLString.class)
        {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("<"+Rootstr+">");
            strBuilder.append(coverter(xmlOrJsonItem));
            strBuilder.append("</"+Rootstr+">");
            return strBuilder.toString();
        }
    }
    public static String converterCutHeadForXmlItem(Map<String, String> dataMap,String Rootstr)
    {
        synchronized (MapToXMLString.class)
        {
            StringBuilder strBuilder = new StringBuilder();
